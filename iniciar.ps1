...
Write-Host ""
Write-Host " Usuarios de demostración (contraseña: Demo1234!):"
Write-Host "   admin@bodegademo.cl          Administrador"
Write-Host "   jefe.bodega@bodegademo.cl    Jefe de Bodega"
Write-Host "   operador@bodegademo.cl       Operador de Bodega"
Write-Host "   compras@bodegademo.cl        Compras"
Write-Host "   solicitante@bodegademo.cl    Solicitante"
Write-Host "   aprobador@bodegademo.cl      Aprobador"
Write-Host "   auditor@bodegademo.cl        Auditor"
Write-Host "   gerencia@bodegademo.cl       Gerencia"
Write-Host ""
